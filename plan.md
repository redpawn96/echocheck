...
7. Draft AGENTS.md with 3 specialized roles: Platform Agent, GEO Agent, Video Agent, plus shared constraints (coding style, testing, cost controls, API key handling, queue/idempotency patterns).
8. Define handoff contracts in AGENTS.md:
9. Platform Agent owns auth, billing, usage metering, shared UI shell, observability.
...
**Relevant files**
- /home/jcatonph/Projects/Apps/echocheck/AGENTS.md - agent roles, constraints, handoff contracts, and DoD checklists.
...
- Agent structure confirmed: Platform + GEO + Video specialized agents.
